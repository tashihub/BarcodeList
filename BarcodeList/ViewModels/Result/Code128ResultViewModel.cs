...
namespace BarcodeList.ViewModels.Result
{
    public partial class Code128ResultViewModel : ObservableObject, IQueryAttributable
    {
        ...
        public Code128ResultViewModel(FolderService folderService)
        {
        ...
        private async Task Save()
        {
            ...
            bool success = await _folderService.SaveToFolderAsync(Code128Value, BarcodeFormat.Code128, SelectedFolder);
            if (success)
            {
